...
<div class="clock-digi">
    <div><div><div class="day"></div><?php esc_html_e('Days', 'mbstore');?></div></div>
    <div><div><div class="hours"></div><?php esc_html_e('Hours', 'mbstore');?></div></div>
    <div><div><div class="minutes"></div><?php esc_html_e('Mins', 'mbstore');?></div></div>
    <div><div><div class="seconds"></div><?php esc_html_e('Secs', 'mbstore');?></div></div>
</div>
</div>
<?php
$output = ob_get_clean();
