...
global $post, $mbstore_opt, $mbstore_blog_pagination;
$mbstore_blog_pagination = $pagination;
...
if( have_posts() ) :
	mbstore_set_themeoption('blog_class', ' sns-blog-page '.$extra_class);
	mbstore_set_themeoption('blog_type', $blog_type);
	mbstore_set_themeoption('excerpt_length', $excerpt_length);
	mbstore_set_themeoption('pagination', $pagination);
	mbstore_set_themeoption('masonry_numload', $masonry_numload);
	ob_start();
	?>
