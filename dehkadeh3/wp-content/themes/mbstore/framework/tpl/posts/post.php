    ...
    ?>
        <div class="gallery-thumb">
            ...
            foreach (rwmb_meta('mbstore_post_gallery', 'type=image') as $image) { ?>
            	<?php 
            	$src = $image['full_url'];
            	if ( isset($image['sizes']['mbstore_blog_default_thumb']['file']) && $image['sizes']['mbstore_blog_default_thumb']['file'] ) {
    ...
    <div class="post-content">      
        <div class="content">
            <div class="post-meta">
                ...
                ?>
                <?php if(mbstore_themeoption('show_categories', 1) == 1 && get_the_category_list() ): ?>
