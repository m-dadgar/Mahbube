...
class FeatureFlagEntity extends \MailPoet\Entities\FeatureFlagEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\FeatureFlagEntity' . "\0" . 'name', '' . "\0" . 'MailPoet\\Entities\\FeatureFlagEntity' . "\0" . 'value', '' . "\0" . 'MailPoet\\Entities\\FeatureFlagEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\FeatureFlagEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\FeatureFlagEntity' . "\0" . 'updated_at'];
        }
