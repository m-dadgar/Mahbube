 ...
 * Single Products
 */
cmsmastersShortcodes.cmsmasters_selected_single_products = {
	title : 	cmsmasters_woocommerce_shortcodes.single_products_title, 
	icon : 		'admin-icon-shop', 
	pair : 		false, 
	content : 	false, 
	visual : 	false, 
	...
	fields : { 
		...
		// Products Shortcode Choise
		single_products_shortcode : { 
			type : 		'radio', 
			title : 	cmsmasters_woocommerce_shortcodes.single_products_shortcode_title, 
			descr : 	cmsmasters_woocommerce_shortcodes.single_products_shortcode_descr, 
			def : 		'small_product', 
			required : 	true, 
			width : 	'half', 
			choises : { 
						'small_product' : 		cmsmasters_woocommerce_shortcodes.choice_small_product, 
						'full_product' : 		cmsmasters_woocommerce_shortcodes.choice_full_product
			} 
		}, 
		// IDs
		ids : { 
		...
		product_metadata : { 
			type : 		'checkbox', 
			title : 	cmsmasters_woocommerce_shortcodes.product_signle_field_prmeta_title, 
			descr : 	cmsmasters_woocommerce_shortcodes.product_single_field_prmeta_descr, 
			def : 		'descriptions,rating,price', 
			required : 	true, 
			width : 	'half', 
			choises : { 
				'descriptions' : 		cmsmasters_woocommerce_shortcodes.product_single_field_choice_descriptions, 
				'rating' : 				cmsmasters_woocommerce_shortcodes.product_single_field_choice_rating, 
				'price' : 				cmsmasters_woocommerce_shortcodes.product_single_field_choice_price
			} 
		}, 
		// Additional Classes
		classes : { 
