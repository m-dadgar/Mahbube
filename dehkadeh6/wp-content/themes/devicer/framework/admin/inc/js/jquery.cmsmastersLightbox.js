		...
		obj.methods = { 
			...
			setVars : function () { 
				...
				obj.methods.lbHTML = '<div class="cmsmastersLightBoxOut">' + 
					'<div class="cmsmastersLightBoxBack" />' + 
					'<div class="cmsmastersLightBoxCont">' + 
						'<div class="cmsmastersLightBoxContIn admin-icon-loader animate-spin">' + 
							'<div class="cmsmastersLightBoxContInTop wrap" />' + 
							'<div class="cmsmastersLightBoxContInMid" />' + 
							'<div class="cmsmastersLightBoxContInBot" />' + 
						'</div>' + 
					'</div>' + 
				'</div>';
			}, 
			...
			buildObj : function () { 
				if (obj.methods.options.closeButtons) {
					obj.methods.contInTop.append('<a href="#" class="cmsmastersLightBoxClose admin-icon-remove" title="' + obj.methods.options.closeButtonText + '" />');
