...
if (!function_exists('devicer_get_custom_page_meta_fields')) {
function devicer_get_custom_page_meta_fields() {
	$cmsmasters_option = devicer_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['devicer' . '_layout']) && $cmsmasters_option['devicer' . '_layout'] !== '') ? $cmsmasters_option['devicer' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['devicer' . '_header_overlaps']) && $cmsmasters_option['devicer' . '_header_overlaps'] !== '') ? (($cmsmasters_option['devicer' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'devicer'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'devicer'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'devicer'), 
