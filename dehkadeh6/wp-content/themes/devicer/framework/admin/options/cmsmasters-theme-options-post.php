...
if (!function_exists('devicer_get_custom_post_meta_fields')) {
function devicer_get_custom_post_meta_fields() {
	$cmsmasters_option = devicer_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['devicer' . '_blog_post_layout']) && $cmsmasters_option['devicer' . '_blog_post_layout'] !== '') ? $cmsmasters_option['devicer' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['devicer' . '_blog_post_title']) && $cmsmasters_option['devicer' . '_blog_post_title'] !== '') ? (($cmsmasters_option['devicer' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['devicer' . '_blog_post_share_box']) && $cmsmasters_option['devicer' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['devicer' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['devicer' . '_blog_post_author_box']) && $cmsmasters_option['devicer' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['devicer' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['devicer' . '_blog_more_posts_box'])) ? $cmsmasters_option['devicer' . '_blog_more_posts_box'] : 'related';
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'devicer'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'devicer'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'devicer'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'devicer'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'devicer') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'devicer'), 
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'devicer'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'devicer'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'devicer'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'devicer'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'devicer'), 
			'desc'	=> '', 
