...
if (!function_exists('devicer_get_custom_profile_meta_fields')) {
function devicer_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['devicer' . '_profile_post_title']) && $cmsmasters_option['devicer' . '_profile_post_title'] !== '') ? (($cmsmasters_option['devicer' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['devicer' . '_profile_post_details_title']) && $cmsmasters_option['devicer' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['devicer' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['devicer' . '_profile_post_share_box']) && $cmsmasters_option['devicer' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['devicer' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'devicer'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'devicer'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'devicer'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'devicer'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'devicer'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'devicer'), 
			'desc'	=> '', 
