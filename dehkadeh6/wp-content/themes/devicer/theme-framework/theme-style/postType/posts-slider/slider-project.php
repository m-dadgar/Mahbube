...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_slider_project'); ?>>
	...
	<?php 
		$title ? devicer_slider_post_heading(get_the_ID(), 'project', 'h3', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, true, $cmsmasters_project_link_target) : '';
					...
					'<div class="cmsmasters_slider_project_cont_wrap_inner">';
						...
						if ($comments || $likes) {
							echo '<footer class="cmsmasters_slider_project_footer entry-meta">';
								...
								($comments) ? devicer_get_slider_post_comments('project') : '';
								
								($likes) ? devicer_slider_post_like('project') : '';
