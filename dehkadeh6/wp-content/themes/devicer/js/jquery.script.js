...
jQuery(document).ready(function() { 
	...
	(function ($) { 
		$('#navigation_mid').cmsmastersResponsiveNav();
	} )(jQuery);
	

	/* Responsive Navigation Function Start 2 */
	(function ($) { 
	...
	(function ($) { 
		...
		$('body').scrollspy({target: '#navigation_mid'});
		
		$('body').scrollspy({target: '#navigation'});
		
		
		$('#navigation_mid a').on('click', function(event) {
			if (this.hash !== "") {
