...
class Cmsmasters_Demo_Content_Importer extends Cmsmasters_Theme_Importer {
	...
	public function set_demo_menus() {
		...
		$cat_menu = get_term_by('name', $menus['cat_menu'], 'nav_menu');
...
function devicer_run_importer() {
	new Cmsmasters_Demo_Content_Importer();
}

add_action('init', 'devicer_run_importer');
